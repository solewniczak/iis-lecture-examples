...
class ReviewDataset(Dataset):
    ...
    @classmethod
    def load_dataset_and_make_vectorizer(cls, reviews_json_filepath, words_limit=1000, reviews_limit=(0, 5000)):
        reviews = cls.read_json(reviews_json_filepath, limit=reviews_limit)
        vectorizer = ReviewVectorizer.from_json(reviews, words_limit=words_limit)
