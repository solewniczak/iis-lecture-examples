...
dataset = ReviewDataset.load_dataset_and_make_vectorizer(args.reviews_json_filepath, reviews_limit=args.reviews_train,
                                                 words_limit=args.words_limit, max_review_words=args.max_review_words)
...
classifier = ReviewClassifier(in_features=len(vectorizer.review_vocab), out_features=len(vectorizer.rating_vocab),
                              hidden_features=args.hidden_features, dropout_p=args.dropout_p)
classifier.to(args.device)
summary(classifier, (len(vectorizer.review_vocab), args.max_review_words))
