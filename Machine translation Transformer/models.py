...
# Transofrmer implementation from: https://github.com/SamLynnEvans/Transformer
...
class Transformer(nn.Module):
    def __init__(self, source_vocab_size, target_vocab_size, d_model, N, heads):
        super().__init__()
        self.encoder = Encoder(source_vocab_size, d_model, N, heads)
        self.decoder = Decoder(target_vocab_size, d_model, N, heads)
